# Melissa Valencia
# CS 76 AI, Fall 2021
# this code was provided in PA2
# altered structure of maze in lines 72-84, maze now in format of colors: rgby instead of .s
...
class Maze:
    ...
    # returns True if the location is a floor by checking letters corresponding to color
    def is_floor(self, x, y):
        ...
        # altered to return if the given is one of the valid colors
        return self.map[self.index(x, y)] in ['r', 'g', 'b', 'y']

    # returns what color is at given coordinate
    def what_color(self, x, y):
        return self.map[self.index(x, y)]
